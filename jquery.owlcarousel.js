"function" != typeof Object.create && (Object.create = function(t) {
    ...
    function(t, i, e) {
        var s = {
            init: function(i, e) {
                this.$elem = t(e), this.options = t.extend({}, t.fn.owlCarousel.options, this.$elem.data(), i), this.userOptions = i, this.loadContent()
            },
            loadContent: function() {
                ...
                var e, s = this;
                "function" == typeof s.options.beforeInit && s.options.beforeInit.apply(this, [s.$elem]), "string" == typeof s.options.jsonPath ? (e = s.options.jsonPath, t.getJSON(e, i)) : s.logIn()
            },
            logIn: function() {
            ...
            eachMoveUpdate: function() {
                this.mgzLazyLoad(), !0 === this.options.lazyLoad && this.lazyLoad(), !0 === this.options.autoHeight && this.autoHeight(), this.onVisibleItems(), "function" == typeof this.options.afterAction && this.options.afterAction.apply(this, [this.$elem])
            },
            mgzLazyLoad: function() {
                var i, e, s, o, n;
                for (i = 0; i < this.itemsAmount; i += 1) e = t(this.$owlItems[i]), "loaded" !== e.data("owl-loaded") && (s = e.data("owl-item"), o = e.find("img"), "string" != typeof o.data("src") ? e.data("owl-loaded", "loaded") : (void 0 === e.data("owl-loaded") && (o.hide(), e.addClass("loading").data("owl-loaded", "checked")), (n = !0 === this.options.lazyFollow ? s >= this.currentItem : !0) && s < this.currentItem + this.options.items && o.length && this.lazyPreload(e, o)))
            },
            updateVars: function() {
            ...
            updateItems: function() {
                ...
                if (i = t(this.options.responsiveBaseWidth).width(), i > (this.options.itemsDesktop[0] || this.orignalItems) && (this.options.items = this.orignalItems), !1 !== this.options.itemsCustom)
                    for (this.options.itemsCustom.sort(function(t, i) {
                            return t[0] - i[0]
                        }), e = 0; e < this.options.itemsCustom.length; e += 1) this.options.itemsCustom[e][0] <= i && (this.options.items = this.options.itemsCustom[e][1]);
            ...
            response: function() {
                var e, s, o = this;
                return !0 !== o.options.responsive ? !1 : (s = t(i).width(), o.resizer = function() {
                    t(i).width() !== s && (!1 !== o.options.autoPlay && i.clearInterval(o.autoPlayInterval), i.clearTimeout(e), e = i.setTimeout(function() {
                        s = t(i).width(), o.updateVars()
            ...
            appendItemsSizes: function() {
                ...
                i.$owlItems.each(function(o) {
                    ...
                    n.css({
                        width: i.itemWidth
                    }).data("owl-item", Number(o)), 0 !== o % i.options.items && o !== s || o > s || (e += 1), n.data("owl-roundPages", e)
                })
            },
            ...
            loops: function() {
                var i, e, s = 0,
                    o = 0;
                for (this.positionsInArray = [0], this.pagesInArray = [], i = 0; i < this.itemsAmount; i += 1) o += this.itemWidth, this.positionsInArray.push(-o), !0 === this.options.scrollPerPage && (e = t(this.$owlItems[i]), e = e.data("owl-roundPages"), e !== s && (this.pagesInArray[s] = this.positionsInArray[i], s = e))
            },
            ...
            buildButtons: function() {
                ...
                i.owlControls.append(e), i.buttonPrev = t("<div/>", {
                    "class": "owl-prev",
                    html: i.options.navigationText[0] || ""
                }), i.buttonNext = t("<div/>", {
                    "class": "owl-next",
                    html: i.options.navigationText[1] || ""
                }), e.append(i.buttonPrev).append(i.buttonNext), e.on("touchstart.owlControls mousedown.owlControls", 'div[class^="owl"]', function(t) {
                    t.preventDefault()
                }), e.on("touchend.owlControls mouseup.owlControls", 'div[class^="owl"]', function(e) {
                    e.preventDefault(), t(this).hasClass("owl-next") ? i.next() : i.prev()
                })
            },
            buildPagination: function() {
                var i = this;
                i.paginationWrapper = t('<div class="owl-pagination"/>'), i.owlControls.append(i.paginationWrapper), i.paginationWrapper.on("touchend.owlControls mouseup.owlControls", ".owl-page", function(e) {
                    e.preventDefault(), Number(t(this).data("owl-page")) !== i.currentItem && i.goTo(Number(t(this).data("owl-page")), !0)
                })
            },
            updatePagination: function() {
                var i, e, s, o, n, a;
                if (!1 === this.options.pagination) return !1;
                for (this.paginationWrapper.html(""), i = 0, e = this.itemsAmount - this.itemsAmount % this.options.items, o = 0; o < this.itemsAmount; o += 1) 0 === o % this.options.items && (i += 1, e === o && (s = this.itemsAmount - this.options.items), n = t("<div/>", {
                    "class": "owl-page"
                }), a = t("<span></span>", {
                    text: !0 === this.options.paginationNumbers ? i : "",
                    "class": !0 === this.options.paginationNumbers ? "owl-numbers" : ""
                }), n.append(a), n.data("owl-page", e === o ? s : o), n.data("owl-roundPages", i), this.paginationWrapper.append(n));
            ...
            goTo: function(t, e, s) {
                var o = this;
                return o.isTransition ? !1 : ("function" == typeof o.options.beforeMove && o.options.beforeMove.apply(this, [o.$elem]), t >= o.maximumItem ? t = o.maximumItem : 0 >= t && (t = 0), o.currentItem = o.owl.currentItem = t, !1 !== o.options.transitionStyle && "drag" !== s && 1 === o.options.items && !0 === o.browser.support3d ? (o.swapSpeed(0), !0 === o.browser.support3d ? o.transition3d(o.positionsInArray[t]) : o.css2slide(o.positionsInArray[t], 1), o.afterGo(), o.singleItemTransition(), !1) : (t = o.positionsInArray[t], !0 === o.browser.support3d ? (o.isCss3Finish = !1, !0 === e ? (o.swapSpeed("paginationSpeed"), i.setTimeout(function() {
                    o.isCss3Finish = !0
                }, o.options.paginationSpeed)) : "rewind" === e ? (o.swapSpeed(o.options.rewindSpeed), i.setTimeout(function() {
                    o.isCss3Finish = !0
                }, o.options.rewindSpeed)) : (o.swapSpeed("slideSpeed"), i.setTimeout(function() {
                    o.isCss3Finish = !0
                }, o.options.slideSpeed)), o.transition3d(t)) : !0 === e ? o.css2slide(t, o.options.paginationSpeed) : "rewind" === e ? o.css2slide(t, o.options.rewindSpeed) : o.css2slide(t, o.options.slideSpeed), void o.afterGo()))
            },
            jumpTo: function(t) {
            ...
            checkBrowser: function() {
                ...
                var t = t.style.cssText.match(/translate3d\(0px, 0px, 0px\)/g),
                    t = null !== t && 1 <= t.length && 2 >= t.length,
                    s = /MSIE ([0-9]+)/.exec(navigator.userAgent);
                null !== s && 10 >= s[1] ? 10 == s[1] ? t = !0 : 10 > s[1] && (t = !1) : (s = /Trident.*rv[ :]*([0-9]+)/.exec(navigator.userAgent), null !== s && 11 <= s[1] && (t = !0)), this.browser = {
                    support3d: t,
            ...
            gestures: function() {
                ...
                r.isCssFinish = !0, r.$elem.on(r.ev_types.start, ".owl-wrapper", function(e) {
                    ...
                    if (!(r.itemsAmount <= r.options.items)) {
                        ...
                        !1 !== r.options.autoPlay && i.clearInterval(r.autoPlayInterval), !0 === r.browser.isTouch || r.$owlWrapper.hasClass("grabbing") || r.$owlWrapper.addClass("grabbing"), r.newPosX = 0, r.newRelativeX = 0, t(this).css(r.removeTransition()), n = t(this).position(), l.relativePos = n.left, l.offsetX = s(e).x - n.left, l.offsetY = s(e).y - n.top, o("on"), l.sliding = !1, l.targetElement = e.target || e.srcElement
                    }
                })
            },
            ...
            lazyPreload: function(t, e) {
                function s() {
                    t.data("owl-loaded", "loaded").removeClass("loading"), e.removeClass("lazy-loading").addClass("lazy-loaded"), e.removeAttr("data-src"), "fade" === a.options.lazyEffect ? e.fadeIn(400) : e.show(), "function" == typeof a.options.afterLazyLoad && a.options.afterLazyLoad.apply(this, [a.$elem])
                }

                function o() {
                    r += 1, a.completeImg(e.get(0)) || !0 === n ? s() : 100 >= r ? i.setTimeout(o, 100) : s()
                }
                var n, a = this,
                    r = 0;
                "DIV" === e.prop("tagName") ? (e.css("background-image", "url(" + e.data("src") + ")"), n = !0) : e[0].src = e.data("src"), o()
            },
            autoHeight: function() {
                function e() {
                    var e = t(n.$owlItems[n.currentItem]).height();
                    n.wrapperOuter.css("height", e + "px"), n.wrapperOuter.hasClass("autoHeight") || i.setTimeout(function() {
                        n.wrapperOuter.addClass("autoHeight")
                    }, 0)
                }

                function s() {
                    o += 1, n.completeImg(a.get(0)) ? e() : 100 >= o ? i.setTimeout(s, 100) : n.wrapperOuter.css("height", "")
                }
                var o, n = this,
                    a = t(n.$owlItems[n.currentItem]).find("img");
                void 0 !== a.get(0) ? (o = 0, s()) : e()
            },
            ...
            singleItemTransition: function() {
                ...
                }), s.addClass(e).on("webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend", function() {
                    t.endCurrent = !0, s.off("webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend"), t.clearTransStyle(s, e)
                })
            },
            ...
            clearEvents: function() {
                this.$elem.off(".owl owl mousedown.disableTextSelect"), t(e).off(".owl owl"), t(i).off("resize", this.resizer)
            },
            unWrap: function() {
            ...
            addItem: function(t, i) {
                var e;
                return t ? 0 === this.$elem.children().length ? (this.$elem.append(t), this.setVars(), !1) : (this.unWrap(), e = void 0 === i || -1 === i ? -1 : i, e >= this.$userItems.length || -1 === e ? this.$userItems.eq(-1).after(t) : this.$userItems.eq(e).before(t), void this.setVars()) : !1
            },
